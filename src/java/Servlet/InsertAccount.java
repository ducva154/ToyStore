 ...
 * @author ANHDUC
 */
@WebServlet(name = "InsertAccount", urlPatterns = {"/InsertAccount"})
public class InsertAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Add account");
...
//        processRequest(request, response);
        ...
        if (acc == null) {
            dao.insertAccount(user, pass, gender, dob, address, email, phone, role, true, quesID, ans);
