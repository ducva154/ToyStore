        ...
        <div class="login">            
            <form  action="ProfileControl" method="post">
                <table>
                    <tr>
                        <td>User name:</td>
                        <td><input type="text" name="username" value="${sessionScope.account.username}" readonly required></td>
                    </tr>
                    <tr>
                        <td>Gender:</td>
                        <td>
                            <input type="radio" name="gender" value="male" <c:if test="${sessionScope.account.gender == true}">checked</c:if>> Male
                            <input type="radio" name="gender" value="female"<c:if test="${sessionScope.account.gender == false}">checked</c:if>> Female
                        </td>
                    </tr>
                    <tr>
                        <td>Date of birth:</td><td><input type="date" name="dob" value="${sessionScope.account.dob}" style="width: 200px;" required></td>
                    </tr>
                    <tr>
                        <td>Address:</td><td><input type="text" name="address" value="${sessionScope.account.address}" style="width: 200px;" required></td>
                    </tr>
                    <tr>
                        <td>Email:</td><td><input type="email" name="email" value="${sessionScope.account.email}" style="width: 200px;" required></td>
                    </tr>
                    <tr>
                        <td>Phone Number:</td><td><input type="text" name="phone" value="${sessionScope.account.phone}" style="width: 200px;" required></td>
                    </tr>
                    <tr>
                        <td id="form-button" colspan="2"><input type="submit" value="Edit"> </td>
                    </tr>
                    <tr>
                        <td id="link-changepass" colspan="2"><a href="ChangePassword">Change password</a></td>
                    </tr>
                </table>   
            </form>
