            ...
            <form action='InsertProduct' method='post'>
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="price" value="0.0" required></td>
                    </tr>
                    <tr>
                        <td><label>Description</label></td>
                        <td><textarea name="description" rows="5" cols="30" style="width: 160px;" required></textarea></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name ="category"  style="width: 165px;">
                                <%
                                    ...
                                    for (Map.Entry<Integer, Category> en : hmCategory.entrySet()) {
                                        String key = String.valueOf(en.getKey());
                                        Category val = en.getValue();%>
                                <option value="<%=key%>"><%=val.getCategoryName()%></option>
                                <%
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="quantity" value="0" required></td>
                    </tr>
                    <tr>
