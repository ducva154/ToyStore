    ...
    <body>
        ...
        <div class="main">
            ...
            <%
                ...
                int quesID = acc.getQuestion();
                String answer = acc.getAnswer();
            %>
            <form action='UpdateAccount' method='post'>
                <table>
                    <tr>
                        <td>User name:</td>
                        <td><input type="text" name="username" value="<%=user%>" readonly required></td>
                    </tr>
                    <tr>
                        <td>Password:</td>
                        <td><input type="text" name="password" value="<%=pass%>" required></td>
                    </tr>
                    <tr>
                        <td>Gender:</td>
                        <td>
                    ...
                    <tr>
                        <td>Date of birth:</td><td><input type="date" name="dob" value="<%=dob%>" style="width: 160px;" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Phone Number:</td><td><input type="text" name="phone" value="<%=phone%>" required></td>
                    </tr>
                    <tr>
                        <td>Role:</td>
                        <td>
                    ...
                    <tr>
                        <td>Active state:</td>
                        <td>
                            <input type="checkbox" name="active" value="actived" <%=active?"checked":""%>> Actived
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name ="question" style="width: 165px;">
                                ...
                                <option value="<%=key%>" <%=(key==quesID ? "selected" : "")%>><%=val%></option>
                                <%
                                    }%>
                            </select>
                        </td>
                    ...
                    <tr>
                        <td>Answer:</td><td><input type="text" name="answer" value="<%=answer%>" required></td>
                    </tr>
                    <tr>
                        <td id="form-button" colspan="2"><input type="submit" value="Update"> </td>
                    </tr>
                </table> 
            </form>
        </div>
