    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="tab-contents tab-contents-1">
                <a class="button-add" href="InsertProduct">Add new product</a>
                <table class="manage-product">
                    ...
                    <%
                        ...
                        for (Map.Entry<Integer, Product> en : hmProduct.entrySet()) {
                            Integer key = en.getKey();
                            Product val = en.getValue();
                            int categoryID = val.getCategoryID();
                            String typeName = hmCategory.get(categoryID).getCategoryName();
                            out.println("<tr>");
                            out.println(val.outTable(typeName));%>
                            <td><a href="UpdateProduct?id=<%=key%>"><i class="fas fa-edit"></i></a></td>    
                            <td><a href="Delete?id=<%=key%>"><i class="fas fa-trash-alt"></i></a></td>
                            <%out.println("</tr>");
                        }
                    %>
                </table>
